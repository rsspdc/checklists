...
- [ ] Project is suitably licensed
    - [ ]  	🥉Bronze (easy): There is a LICENSE file in the repository for a license which meets one of the [OSI](https://opensource.org/osd), Debian, or FSF definitions of free/libre or open source software. Or if the contents are not software a [Creative Commons](https://creativecommons.org/) license.
